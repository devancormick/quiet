...
final class BlockDayLog {
    ...
    private let processingQueue = DispatchQueue(label: "QuietBlockDayLogQueue")
    
    private static let kIsBlockLogDisabled = "QuietIsBlockLogDisabled"
    
    private static let userDefaultsKey = "QuietDayLogs"
