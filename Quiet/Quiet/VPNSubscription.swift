...
actor VPNSubscription: NSObject {
    ...
    static let productIdAdvancedMonthly = "QuietFirewallMonthly"
    static let productIdAdvancedYearly = "QuietFirewallAnnual"
    static let productIdMonthly = "QuietVpnMonthly"
    static let productIdAnnual = "QuietVpnAnnual"
    static let productIdMonthlyPro = "QuietVpnMonthlyPro"
    static let productIdAnnualPro = "QuietVpnAnnualPro"
    ...
    static let onboardingProducts = OneTimeProducts(weekly: "lockdown.weekly.5.202502.no_trial.onboarding",
                                                    weeklyTrial: "lockdown.weekly.5.202502.3_days_free_trial.onboarding",
                                                    yearly: "lockdown.yearly.60.202502.no_trial.onboarding",
                                                    yearlyTrial: "lockdown.yearly.60.202502.3_days_free_trial.onboarding")
