...
class WhatsNewViewController: UIViewController {
    ...
    private lazy var navigationView: CustomNavigationView = {
        ...
        view.titleView.font = .boldQuietFont(size: 17)
    ...
    private lazy var headerView: UIView = {
        headerView(
            withTitle: NSLocalizedString("Quiet 2.0", comment: "Quiet title"),
            andSubtitle: NSLocalizedString("Quiet 2.0 brings a variety of new features to the world's first fully audited and Openly Operated privacy app!", comment: "Quiet subtitle")
        )
    }()
    
    private lazy var protectionLevelsView: UIView = {
        let titleLable = UILabel()
        titleLable.font = .boldQuietFont(size: 22)
    ...
    private func headerView(
        ...
        let titleLable = UILabel()
        titleLable.font = .boldQuietFont(size: titleFontSize)
        titleLable.textColor = .label
        titleLable.numberOfLines = 0
    ...
    private func secondaryLabel() -> UILabel {
        let label = UILabel()
        label.font = .regularQuietFont(size: 15)
