...
final class WelcomeView: UIView {
    ...
    private lazy var descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = NSLocalizedString("You will notice your Quiet app looks a bit different. We’ve been working hard on creating a more powerful, usable and informative privacy tool. We are fully open source and open audited (Feb 2023).", comment: "")
        label.textColor = .white
    ...
    private lazy var subTitleLable: UILabel = {
        let label = UILabel()
        label.text = NSLocalizedString("With the new Quiet:", comment: "")
        label.textColor = .white
    ...
    private lazy var descriptionLabel2: UILabel = {
        let label = UILabel()
        label.text = NSLocalizedString("You can access these new firewall features by starting a trial for our new “Advanced” subscription plan. We are hard at work improving these features and fixing any bugs that arise. Please give it a try and reach out with any feedback to team@example.com.", comment: "")
        label.textColor = .white
        label.font = fontMedium15
        label.textAlignment = .left
        label.numberOfLines = 0
