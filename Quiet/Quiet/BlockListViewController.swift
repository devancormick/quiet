...
final class BlockListViewController: BaseViewController {
    ...
    private let paragraphLabel: UILabel = {
        ...
        view.text = NSLocalizedString("Block all your apps from connecting to the domains and sites below. For your convenience, Quiet also has pre-configured suggestions.", comment: "")
        return view
    }()
