...
struct OneTimePaywallView: View {
    ...
    private var title: some View {
        Group {
            Text("Tap")
                .foregroundColor(.white)
            + Text("Paywall.Onetime.Continue")
                .foregroundColor(Color("Quiet Blue"))
    ...
    private var trialToggle: some View {
        HStack {
            ...
            Toggle(isOn: $model.trialEnabled, label: {})
                .toggleStyle(SwitchToggleStyle(tint: Color("Quiet Blue")))
                .frame(maxWidth: 60)
        }
        .modifier(BubbleBg())
    }
    ...
    private var yearlyProduct: some View {
        ZStack {
            ...
            .modifier(BubbleBg(lineColor: model.activePlan == .yearly ? Color("Quiet Blue") : .gray))
    ...
    private var weeklyProduct: some View {
        ...
        .modifier(BubbleBg(lineColor: model.activePlan == .weekly ? Color("Quiet Blue") : .gray))
        .contentShape(Rectangle())
        .onTapGesture {
...
struct BubbleBg: ViewModifier {
    let lineColor: Color
    init (lineColor: Color = Color("Quiet Blue")) {
