...
enum Email {
    ...
    var subject: String {
        ...
        switch self {
        case .helpOrFeedback:
            return "Quiet Question or Feedback (iOS \(Bundle.main.versionString))" + appendString
        case .deleteAccount:
            return "Delete Account"
        case .termsAndPrivacyPolicy:
            return "Quiet Privacy Policy Question or Feedback (iOS \(Bundle.main.versionString))" + appendString
        case .blockingImprovementIdeas:
            return "Quiet Blocking Improvement Ideas (iOS \(Bundle.main.versionString))"
    ...
    var body: String {
        switch self {
        case .helpOrFeedback:
            return "Hi, my question or feedback for Quiet is: "
        ...
        case .termsAndPrivacyPolicy:
            return "Hi, my question or feedback for Quiet Privacy Policy is: "
        case .blockingImprovementIdeas:
            return "Hi, my blocking improvement ideas for Quiet Privacy are: "
