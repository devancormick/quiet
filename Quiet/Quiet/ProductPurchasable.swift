...
you'll need to sign in with the same email address. Otherwise, start your free trial or e-mail team@example.com
"""),
...
"""
                ...
                default:
                    let pleaseEmail: String = .localized("Please email team@example.com with the following Error Code ")
                    self.showPopupDialog(
...
Please make sure your Internet connection is active. If this error persists, email team@example.com with
