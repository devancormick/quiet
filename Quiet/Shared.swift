...
let keychain = Keychain(service: "com.example.quiet.tunnels").synchronizable(true)
...
let kICloudContainer = "iCloud.com.example.quiet"
...
func getAPICredentialsQuiet() -> Bool {
    return defaults.bool(forKey: kAPICredentialsQuiet)
}

func setAPICredentialsQuiet(confirmed: Bool) {
    defaults.set(confirmed, forKey: kAPICredentialsQuiet)
}
...
extension UIColor {
    static let confirmedBlue = UIColor(named: "Quiet Blue") ?? UIColor.tunnelsBlue
