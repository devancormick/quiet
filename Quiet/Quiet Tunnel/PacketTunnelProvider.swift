...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    let groupContainer = "group.com.example.quiet"
...
extension PacketTunnelProvider {
    ...
    #if DEBUG
    static let debugLogsKey = AppGroupStorage.Key<[String]>(rawValue: "com.example.quiet.packettunnelprovider.debuglogs")
