...
func flushBlockLog( log: (String) -> Void) {
    ...
    let sharedDir = fileManager.containerURL(forSecurityApplicationGroupIdentifier: "group.com.example.quiet")
...
enum ProtectedFileAccess {
    ...
    private static let fileURL = FileManager.default
        .containerURL(forSecurityApplicationGroupIdentifier: "group.com.example.quiet")!
...
enum PacketTunnelProviderLogs {
    ...
    static let userDefaultsKey = "com.example.quiet.ne_temporaryLogs"
...
final class AppGroupStorage {
    ...
    static let directoryURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.example.quiet")!.appendingPathComponent("AppGroupStorage", isDirectory: true)
